 ...
 *
 */
public class TestResourcesCorpusListCorpusSegments extends BaseTestClassExtended {
	
	@Test
	public void corpusListCorpusSegments() throws InterruptedException, IOException, ParseException{
		ResourcesCorpus resourcecorpus=PageFactory.initElements(driver, ResourcesCorpus.class);
		Assert.assertTrue(resourcecorpus.corpusListCorpusSegments());
