 ...
 *
 */
public class TestResourcesDictionaryExportADictionary extends BaseTestClassExtended {
	
	@Test
	public void dictionaryExportADictionary() throws InterruptedException, ParseException{
		
		ResourcesDictionary lookup=PageFactory.initElements(driver, ResourcesDictionary.class);
		Assert.assertTrue(lookup.dictionaryExportADictionary());
