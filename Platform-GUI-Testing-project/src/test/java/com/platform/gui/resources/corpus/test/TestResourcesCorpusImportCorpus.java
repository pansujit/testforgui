 ...
 *
 */
public class TestResourcesCorpusImportCorpus extends BaseTestClassExtended {
	
	@Test
	public void corpusImportCorpus() throws InterruptedException, IOException, ParseException{
		ResourcesCorpus resourcecorpus=PageFactory.initElements(driver, ResourcesCorpus.class);
		Assert.assertTrue(resourcecorpus.corpusImportCorpus());
