 ...
 *
 */
public class TestResourcesCorpusUpdateCorpusSegment extends BaseTestClassExtended {
	
	@Test
	public void corpusUpdateCorpusSegment() throws InterruptedException, IOException, ParseException{
		ResourcesCorpus resourcecorpus=PageFactory.initElements(driver, ResourcesCorpus.class);
		Assert.assertTrue(resourcecorpus.corpusUpdateCorpusSegment());
