 ...
 *
 */
public class TestResourcesCorpusUpdateCorpusProperties extends BaseTestClassExtended {
	
	@Test
	public void corpusUpdateCorpusProperties() throws InterruptedException, IOException, ParseException{
		ResourcesCorpus resourcecorpus=PageFactory.initElements(driver, ResourcesCorpus.class);
		Assert.assertTrue(resourcecorpus.corpusUpdateCorpusProperties());
