 ...
 *
 */
public class TestResourcesDictionaryLookUp extends BaseTestClassExtended {
	
	@Test
	public void dictionaryLookup() throws InterruptedException{
		
		ResourcesDictionary lookup=PageFactory.initElements(driver, ResourcesDictionary.class);
		Assert.assertTrue(lookup.dictionaryLookUp());
